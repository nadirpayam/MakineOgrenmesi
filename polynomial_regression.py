...
# modelin basit regresyon ile eğitilmesi, ilk önce basitle eğitiyoruz
...
poly_reg = PolynomialFeatures(degree = 3) #kaçıncı dereceden artıyor veriler
X_poly = poly_reg.fit_transform(X)
poly_reg.fit(X_poly, y)
lin_reg_2 = LinearRegression()
lin_reg_2.fit(X_poly, y) #lineer regresyon değerleri üstel şekilde vermiş olduk ki polinom olduğu anlaşılsın
#derecenin ideali 2-3 
...
#artış polinomsal olduğu için polinom regresyon kullanıyoruz