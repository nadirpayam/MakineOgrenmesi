...
# Özellik ölçekleme, değerleri aynı aralığa alıyoruz
from sklearn.preprocessing import MinMaxScaler #standart scaler -1 +1 idi minmax 0-1 arasında sıkıştıryor
sc_X = MinMaxScaler()
...
#eğer tahmin edeceğimiz colon sayısalda regresypn
#kategorik veriler, 0-1 değerlerden oluşuyorsa classficiaton problemidir
